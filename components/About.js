...
export default function About(){
    return(
        <div id="ABOUT" className=" mt-15 w-full h-auto flex flex-col gap-[4vw] items-center fade-in ">
            ...
            height = {500}
         />     
                 <h1 className="my-5 text-red-700 text-2xl font-bold italic fade-in">ABOUT</h1>
         ...
         <div className="mt-15 p-15 w-full h-auto px-7 flex flex-row items-center justify-center fade-in bg-black rounded-3xl">
            <Imageslider
             ID = {1}
             width = {500}
             height = {300}
           />
            ...
            <div className=" w-auto h-auto flex flex-col gap-[4vw] items-center justify-center" >
                 <h1 className=" text-red-700 text-2xl font-bold italic fade-in text-center">ABOUT NIRIT</h1>
